...
const itActsAsFavoriteMovieModel = (favoriteMovie) => {
  it('Should return the movie has been added', async () => {
  ...
  it('Should handle request to remove a movie even though the movie has not added', async () => {
    favoriteMovie.putMovie({ id: 1 });
    favoriteMovie.putMovie({ id: 2 });
    favoriteMovie.putMovie({ id: 3 });
  ...
  it('Should be able to search for movie', async () => {
